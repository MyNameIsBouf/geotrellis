...
class KryoRegistrator extends SparkKryoRegistrator {
  ...
  override def registerClasses(kryo: Kryo) {
    ...
    kryo.register(classOf[geotrellis.layers.io.index.rowmajor.RowMajorSpatialKeyIndex])
    kryo.register(classOf[geotrellis.layers.io.index.zcurve.ZSpatialKeyIndex])
    kryo.register(classOf[geotrellis.layers.io.index.zcurve.ZSpaceTimeKeyIndex])
    kryo.register(classOf[geotrellis.layers.io.index.hilbert.HilbertSpatialKeyIndex])
    kryo.register(classOf[geotrellis.layers.io.index.hilbert.HilbertSpaceTimeKeyIndex])
    ...
    kryo.register(classOf[Array[geotrellis.layers.io.avro.AvroRecordCodec[Any]]])
    ...
    kryo.register(classOf[geotrellis.layers.io.avro.codecs.TupleCodec[Any,Any]])
