...
import geotrellis.layers.io.cog.{COGCollectionLayerReaderProvider, COGValueReader, COGValueReaderProvider}
import geotrellis.layers.io.hadoop.HadoopAttributeStore
