...
package geotrellis.layers.io.hadoop.cog
...
import geotrellis.layers.io.cog.{COGCollectionLayerReader, ZoomRange, Extension}
import geotrellis.layers.io.hadoop.conf.HadoopConfig
import geotrellis.layers.io.hadoop.{HadoopAttributeStore, SerializableConfiguration, HdfsUtils}
